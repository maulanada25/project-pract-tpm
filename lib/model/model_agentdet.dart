class AgentDetails {
  ...
  AgentDetails.fromJson(Map<String, dynamic> json)
    : status = json['status'] as int?,
      data = (json['data'] as Map<String,dynamic>?) != null ? DataAgDet.fromJson(json['data'] as Map<String,dynamic>) : null;
...
class DataAgDet {
  ...
  DataAgDet.fromJson(Map<String, dynamic> json)
